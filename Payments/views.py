...
from RRApp.models import Destination
import os
...
def confirmation_mail(request, id):
    if request.user.is_authenticated:
        ...
        <body>
            ...
            <p> Thankyou for purchasing a Travel Package from RR! Your Payment for Booking {name} has been received.</p>
            <br>
            <table>
                <tr>
                    <th>Destination</th>
        ...
        #The subject line
        message['Subject'] = f'Thankyou for your Order : {name} from RR'
        ...
        messages.success(request, f'Thankyou for ordering from RR.com : {name}')
